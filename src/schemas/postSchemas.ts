...
export const guideSchema = z.object({
	...
	email: z.string().email({ message: "Invalid email address" }).min(5, { message: "Email must be 8 or more characters long" }),
	phone: z.string(),
...
export const touristSchema = z.object({
	...
	email: z.string().email({ message: "Invalid email address" }).min(5, { message: "Email must be 8 or more characters long" }).optional(),
