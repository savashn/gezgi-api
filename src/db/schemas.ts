import { integer, pgTable, varchar, text, serial, timestamp, boolean, date, primaryKey } from "drizzle-orm/pg-core";
...
export const Teams = pgTable("teams", {
	...
	flightOutwardDeparture: timestamp("flight_outward_departure", { mode: "string" }),
	flightOutwardDepartureAirport: integer("flight_outward_departure_airport").references(() => Airports.id),
	flightOutwardLanding: timestamp("flight_outward_landing", { mode: "string" }),
	flightOutwardLandingAirport: integer("flight_outward_landing_airport").references(() => Airports.id),
	flightReturnNo: varchar({ length: 255 }),
	flightReturnDeparture: timestamp("flight_return_departure", { mode: "string" }),
	flightReturnDepartureAirport: integer("flight_return_departure_airport").references(() => Airports.id),
